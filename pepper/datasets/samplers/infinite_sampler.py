...
class InfiniteBalancedIdentityDistributedSampler(Sampler):
    def __init__(
        self,
        dataset,
        num_replicas=None,
...
@SAMPLERS.register_module()
class InfiniteSetReWeightDistributedSampler(Sampler):
    def __init__(
        self,
        dataset,
        set_weight: list,
...
@SAMPLERS.register_module()
class InfiniteNaiveIdentityDistributedSampler(Sampler):
    """
