...
"""
I see a lot of face recognition paper use "iresnet",
but it seems different from "improved resnet (2021)"

https://github.com/deepinsight/insightface/blob/master/recognition/arcface_torch/backbones/iresnet.py

- `pretrained` parameter triggers a `ValueError`, so it means they train the backbone from scratch?
"""
